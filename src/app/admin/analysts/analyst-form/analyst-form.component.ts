...
export class AnalystFormComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    //   this.company_logo = this.event['company_logo'];
    // }
  ...
  private _setFormEvent() {
    if (!this.isEdit) {
      ...
      return new FormClientModel(null, null, null,null, null,null,null,null, null, null, null, null, null, null, null, 'Analyst');
    } else {
